...
async def main_agent(content, page,messages):
    ...
    tools = [
        ...
        },
        {
            ...
            "function": {
                "name": "scrapper_agent",
                "description": "Handles tasks related to searching for information on the web and retrieving information from screenshots, such as retrieving information about a person or getting data online or finding information in a screenshot. Call this whenever the user wants navigate to a website or to search for something or get her school timetable or get something from the page you navigated to, for example when a person asks 'what is my timetable like for this week?'",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "content": {
...
def handle_input():
    while True:
        if keyboard.normalize_name().name == 't':
            content = input("User: ")
            return content
...
async def main():
    ...
    async with async_playwright() as p:
        user_data_dir = "C:/Users/saina/AppData/Local/Google/Chrome/User Data"
